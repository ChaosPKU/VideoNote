...
function updateProfileUI(response){
    ...
    for(var i = 0;i < response.messages.noteMessage.length; ++ i){
        ...
        str += "' data-videoInfo = '";
        str += response.messages.noteMessage[i].videoInfo;
        str += "' data-from = '";
    ...
    for(var i = 0;i < response.messages.concernMessage.length; ++ i){
        ...
        str += "' data-videoInfo = '";
        str += response.messages.concernMessage[i].videoInfo;
        str += "' data-URL = '";
    ...
    for(var i = 0;i < response.notes.length; ++ i){
        ...
        str += "' data-videoInfo = '";
        str += response.notes[i].videoInfo;
        str += "' data-from = '";
    ...
    for(var i = 0;i < response.concerns.length; ++ i){
        ...
        str += "' data-videoInfo = '";
        str += response.concerns[i].videoInfo;
        str += "' data-URL = '";
    ...
    for(var i = 0;i < response.collects.length; ++ i){
        ...
        str += "' data-videoInfo = '";
        str += response.collects[i].videoInfo;
        str += "' data-URL = '";
